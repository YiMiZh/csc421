...
if (__name__ == "__main__"):
    ...
    # modle.predict_next_word("he", "is", "the")
    # modle.tsne_plot()
    # print(modle.word_distance("new", "york"))
    print(modle.word_distance("government", "university"))
    print(modle.word_distance("government", "political"))
